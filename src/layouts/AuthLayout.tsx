    ...
    <div className="h-screen w-screen  bg-slate-100 relative z-10 ">
      <div className=" flex items-center size-full px-16 container  ">
        <div className="flex gap-x-24">
          <div className=" w-1/2  ">
            <div className="absolute top-[10%] left-[35%] w-[500px] h-[500px] rounded-full  bg-purple-500 blur-[90px] -z-20"></div>
            <div className="absolute top-[25%] left-[25%] w-[500px] h-[500px] rounded-full  bg-blue-500 blur-[90px] -z-10"></div>
            <div className="absolute top-[40%] left-[15%] w-[500px] h-[500px] rounded-full  bg-green-500 blur-[90px] -z-20"></div>
